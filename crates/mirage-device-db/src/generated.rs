...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct CharDeviceDescriptor {
    pub kind: &'static str,
    pub name: &'static str,
    pub driver_hints: &'static [&'static str],
}
const CHAR_DEVICE_DESCRIPTORS: &[CharDeviceDescriptor] = &[
    ...
    CharDeviceDescriptor {
        kind: "framebuffer-console",
        name: "Framebuffer Console",
        driver_hints: &["fb", "console"],
    },
    CharDeviceDescriptor {
        kind: "null",
        name: "Null Character Device",
        driver_hints: &["devfs"],
    },
    CharDeviceDescriptor {
        kind: "serial-console",
        name: "16550-Compatible Serial Console",
        driver_hints: &["uart16550", "console"],
    },
    CharDeviceDescriptor {
        kind: "virtio-console",
        name: "VirtIO Console Port",
        driver_hints: &["virtio-console", "console"],
    },
];
...
const PCI_VENDOR_DESCRIPTORS: &[PciVendorDescriptor] = &[
    ...
    PciVendorDescriptor {
        id: 0x1234,
        name: "QEMU",
        aliases: &["QEMU Project"],
    },
    PciVendorDescriptor {
        id: 0x1af4,
        name: "VirtIO",
        aliases: &["Red Hat VirtIO"],
    },
    PciVendorDescriptor {
        id: 0x8086,
        name: "Intel",
...
const PCI_DEVICE_DESCRIPTORS: &[PciDeviceDescriptor] = &[
    ...
    PciDeviceDescriptor {
        vendor_id: 0x1022,
        device_id: 0x15e0,
        name: "AMD Renoir Root Complex",
        driver_hint: Some("amd-chipset/platformd"),
    },
    PciDeviceDescriptor {
        vendor_id: 0x1022,
        device_id: 0x15e5,
        name: "AMD Renoir USB 3.1 xHCI Controller",
    ...
    PciDeviceDescriptor {
        ...
        driver_hint: Some("virtio-net/netd"),
    },
    PciDeviceDescriptor {
        vendor_id: 0x1af4,
        device_id: 0x1001,
        name: "VirtIO Block Device",
        driver_hint: Some("virtio-blk/storaged"),
    },
    PciDeviceDescriptor {
        vendor_id: 0x1af4,
        device_id: 0x1002,
        name: "VirtIO Memory Balloon",
        driver_hint: Some("virtio-balloon"),
    },
    PciDeviceDescriptor {
        vendor_id: 0x1af4,
        device_id: 0x1003,
        name: "VirtIO Console",
        driver_hint: Some("virtio-console/console"),
    },
    PciDeviceDescriptor {
        vendor_id: 0x1af4,
        device_id: 0x1004,
        name: "VirtIO SCSI Host",
        driver_hint: Some("virtio-scsi/storaged"),
    },
    PciDeviceDescriptor {
        vendor_id: 0x1af4,
        device_id: 0x1005,
        name: "VirtIO RNG",
        driver_hint: Some("virtio-rng"),
    },
    PciDeviceDescriptor {
        vendor_id: 0x1af4,
        device_id: 0x1009,
        name: "VirtIO 9P Transport",
        driver_hint: Some("virtio-9p/fsd"),
    },
    PciDeviceDescriptor {
        vendor_id: 0x1af4,
        device_id: 0x1050,
        name: "VirtIO GPU",
        driver_hint: Some("virtio-gpu/displayd"),
    },
    PciDeviceDescriptor {
        vendor_id: 0x8086,
        device_id: 0x100e,
        name: "Intel 82540EM Gigabit Ethernet Controller",
        driver_hint: Some("e1000/netd"),
    },
    PciDeviceDescriptor {
        vendor_id: 0x8086,
        device_id: 0x10d3,
        name: "Intel 82574L Gigabit Network Connection",
        driver_hint: Some("e1000e/netd"),
    },
    PciDeviceDescriptor {
        vendor_id: 0x8086,
        device_id: 0x1237,
        name: "Intel 440FX Host Bridge",
        driver_hint: None,
    },
    PciDeviceDescriptor {
        vendor_id: 0x8086,
        device_id: 0x2415,
        name: "Intel 82801AA AC'97 Audio Controller",
        driver_hint: Some("ac97/audiod"),
    },
    PciDeviceDescriptor {
        vendor_id: 0x8086,
        device_id: 0x2668,
        name: "Intel ICH6 HD Audio Controller",
        driver_hint: Some("hda/audiod"),
    },
    PciDeviceDescriptor {
        vendor_id: 0x8086,
        device_id: 0x2918,
        name: "Intel ICH9 LPC Interface Controller",
        driver_hint: None,
    },
    PciDeviceDescriptor {
        vendor_id: 0x8086,
    ...
    PciDeviceDescriptor {
        vendor_id: 0x8086,
        device_id: 0x2934,
        name: "Intel ICH9 USB UHCI Controller",
        driver_hint: Some("uhci/usbd"),
    },
    PciDeviceDescriptor {
        vendor_id: 0x8086,
        device_id: 0x293a,
        name: "Intel ICH9 USB2 EHCI Controller",
        driver_hint: Some("ehci/usbd"),
    },
    PciDeviceDescriptor {
        vendor_id: 0x8086,
        device_id: 0x29c0,
    ...
    PciDeviceDescriptor {
        vendor_id: 0x8086,
        device_id: 0x7010,
        name: "Intel 82371SB PIIX3 IDE Interface",
        driver_hint: Some("ata/storaged"),
    },
    PciDeviceDescriptor {
        vendor_id: 0x8086,
        device_id: 0x7113,
        name: "Intel 82371AB/EB/MB PIIX4 ACPI Bridge",
        driver_hint: None,
    },
];

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct PciClassDescriptor {
    pub class: u8,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct UsbVendorDescriptor {
    pub id: u16,
    pub name: &'static str,
    pub aliases: &'static [&'static str],
}
...
const USB_DEVICE_DESCRIPTORS: &[UsbDeviceDescriptor] = &[
    ...
    UsbDeviceDescriptor {
        ...
        driver_hint: Some("usbhub/usbd"),
    },
    UsbDeviceDescriptor {
        vendor_id: 0x1d6b,
        product_id: 0x0003,
        name: "USB 3.0 Root Hub",
        driver_hint: Some("usbhub/usbd"),
    },
];

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct UsbClassDescriptor {
    pub class: u8,
    pub subclass: Option<u8>,
    pub prog_if: Option<u8>,
    pub name: &'static str,
...
const USB_CLASS_DESCRIPTORS: &[UsbClassDescriptor] = &[
    ...
    UsbClassDescriptor {
        ...
        prog_if: None,
        name: "Mass Storage",
        driver_hint: Some("usb-storage/storaged"),
    },
    UsbClassDescriptor {
        class: 0x09,
        subclass: None,
...
const CHIPSET_DESCRIPTORS: &[ChipsetDescriptor] = &[
    ChipsetDescriptor {
        family: "440FX",
        name: "Intel 440FX/PIIX3 QEMU PC Chipset",
        components: &["host-bridge", "isa-bridge", "ide", "acpi"],
        driver_hints: &["pci", "ata/storaged", "acpi"],
    },
    ChipsetDescriptor {
        family: "Promontory",
        name: "AMD 300/400/500-Series Chipset",
        components: &["pcie-root", "sata", "usb"],
        driver_hints: &["amd-chipset/platformd", "ahci/storaged", "xhci/usbd"],
    },
    ChipsetDescriptor {
        family: "Q35",
        name: "Intel Q35/ICH9 QEMU PC Chipset",
        components: &["host-bridge", "lpc", "ahci", "ehci", "uhci", "hda"],
        driver_hints: &[
            "pci",
            "ahci/storaged",
            "ehci/usbd",
    ...
    ChipsetDescriptor {
        family: "Renoir",
        name: "AMD Ryzen 4000 Mobile SoC",
        components: &["root-complex", "iommu", "xhci", "sata", "gpu"],
        driver_hints: &[
            "amd-chipset/platformd",
            "amd-iommu",
            "xhci/usbd",
            "amdgpu/displayd",
        ],
    ...
    while index < table.len() {
        ...
        if entry.family == family {
            match (entry.model, entry.stepping) {
                ...
                (Some(m), None) if m == model && model_fallback.is_none() => {
...
const fn class_matches(
    entry_class: u8,
    entry_subclass: Option<u8>,
    entry_prog_if: Option<u8>,
    class: u8,
    subclass: u8,
    prog_if: u8,
) -> bool {
    entry_class == class
        && match entry_subclass {
            Some(required) => required == subclass,
            None => true,
        }
        && match entry_prog_if {
            Some(required) => required == prog_if,
            None => true,
        }
}
...
pub const fn lookup_pci_device(
    vendor_id: u16,
    device_id: u16,
) -> Option<&'static PciDeviceDescriptor> {
    let mut index = 0;
...
pub const fn lookup_pci_class(
    ...
    subclass: u8,
    prog_if: u8,
) -> Option<&'static PciClassDescriptor> {
    ...
    while index < PCI_CLASS_DESCRIPTORS.len() {
        ...
        if class_matches(
            ...
            if entry.subclass.is_some() && entry.prog_if.is_some() {
                return Some(entry);
            }
            if fallback.is_none() {
                fallback = Some(entry);
...
pub const fn lookup_usb_device(
    vendor_id: u16,
    product_id: u16,
) -> Option<&'static UsbDeviceDescriptor> {
    let mut index = 0;
...
pub const fn lookup_usb_class(
    class: u8,
    subclass: u8,
    prog_if: u8,
) -> Option<&'static UsbClassDescriptor> {
    let mut fallback = None;
    let mut index = 0;
...
pub fn lookup_char_kind(kind: &str) -> Option<&'static CharDeviceDescriptor> {
    find_char(kind)
}
